    ...
    return (<div>
        <Card className={classes.card}>
            <CardContent>
                ...
                <TextField id="quantity" label="Quantity" className={classes.textField} value={values.quantity} onChange={handleChange('quantity')} margin="normal" /><br/>
                <TextField id="price" label="Price" className={classes.textField} value={values.price} onChange={handleChange('price')} type="number" margin="normal" /><br/> {
                    values.error && (<Typograhy component="p" color="error"><Icon color="error" className={classes.error}>error</Icon>{values.error}</Typograhy>)
                }
            </CardContent>
            <CardActions>
