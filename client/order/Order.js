            ...
            <Grid container spacing={4} >
                ...
                <Grid item xs={5} sm={5} >
                    <Card className={classes.innerCard}>
                        ...
                        <Divider/>
                        <br/>
                        <Typography type="subheading" componenet="h3" className={classes.itemShop} color="primary" >{order.delivery_address.street}</Typography>
                        <Typography type="subheading" componenet="h3" className={classes.itemShop} color="primary" >{order.delivery_address.city}, {order.delivery_address.state} {order.delivery_address.zipcode}</Typography>
                        <Typography type="subheading" componenet="h3" className={classes.itemShop} color="primary" >{order.delivery_address.country}</Typography>
                        <Typography type="subheading" componenet="h3" className={classes.itemShop} color="primary" >Thank you for shopping with us! <br/> You can track the status of your purchased item on this page.</Typography>
                    </Card>
                </Grid>
            </Grid>
        </Card>
