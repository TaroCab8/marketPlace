                        ...
                        return <span key={index}>
                            ...
                            <Collapse component="li" in={open == index} timeout="auto" unmountOnExit >
                                ...
                                <div className={classes.customerDetails} >
                                    ...
                                    <Typography type="subheading" component="h3" color ="primary" ><strong>{order.custormer_name}</strong>({order.customer_email})</Typography>
                                    ...
                                    <Typography type="subheading" component="h3" color ="primary" >{order.delivery_address.country}</Typography>
                                </div>
                            </Collapse>
                            <Divider/>
                        </span>
