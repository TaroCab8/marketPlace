...
export default function Checkout () {
    ...
    return (
        <Card className={classes.card}>
            ...
            <TextField id="street" label="Street" className={classes.streetField} value={values.checkoutDetails.delivery_address.street} onChange={handleCustomerChange('street')} margin="normal" /><br/>
            <TextField id="city" label="City" className={classes.addressField} value={values.checkoutDetails.delivery_address.city} onChange={handleCustomerChange('city')} margin="normal" /><br/>
            <TextField id="state" label="State" className={classes.addressField} value={values.checkoutDetails.delivery_address.state} onChange={handleCustomerChange('state')} margin="normal" /><br/>
            <TextField id="zipcode" label="Zipcode" className={classes.addressField} value={values.checkoutDetails.delivery_address.zipcode} onChange={handleCustomerChange('zipcode')} margin="normal" /><br/>{
