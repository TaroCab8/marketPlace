...
export default function CartItems(props) {
    ...
    return (<Card className={classes.card}>
              ...
              return <span key={i} >
                  ...
                  <div className={classes.details}>
                      <CardContent className={classes.content}>
                          <Link to={'/product/'+ item.product._id} ><Typography>{item.product.name}</Typography></Link>
                          <div>
                      ...
                      <div className={classes.subheading}>
                          Quantity: <TextField value={item.quantity} onChange={handleChange(i)} type="number" inputProps={{min:1}}   className={classes.textField} InputLabelProps={{shrink: true}} margin="normal" />
        ...
        <div className={classes.checkout}>
            ...
            {!props.checkout && (auth.isAuthenticated() ? <Button color="secondary" variant="contained" onClick={openCheckout} >Checkout</Button> : <Link to='/signin' >
        ...
        </span>):<Typography variant="subtitle1" component="h3" color="primary" >No items added to your cart.</Typography>}
    </Card>)
}
